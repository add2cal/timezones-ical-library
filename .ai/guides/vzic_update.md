...
1.  **Check IANA Version:** Find the latest IANA release (e.g., "2026b") as this gets also updated in this flow (there is no vzic-only update process).
2.  **Run Script from root:** ```bash
    sudo sh scripts/update-tzdata.sh 2026b true
    ```
