...
* `src/vzic/Makefile`: Instructions to compile the C source files (`vzic`).
* `src/db-generator.js`: Node script that orchestrates the JSON generation after C tools run.
